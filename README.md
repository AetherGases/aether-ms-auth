...
A **Aether MS Auth** é o microsserviço de autenticação e perfil do Aether. Ela é responsável por fornecer todos oss endpoints utilizados para autenticar um usuário e realizar operações de CRUD com o meu usuário.
...
```bash
git clone https://github.com/AetherGases/aether-ms-auth.git
cd core-api
```
